...
const SHELL_PATTERNS = new Set([
  ...
  'cd', 'cd -', 'cd ..', 'chgrp', 'chgrp sudo ownership.txt', 'chmod', 'chmod +t',
  'chmod +t /home/ghost/projects', 'chmod 640 lockdown.conf', 'chmod 640 secure.conf', 'chmod 640 service.conf',
  'chmod 644', 'chmod 644 /home/ghost/projects/README.md', 'chmod 755',
  'chmod 755 /home/ghost/projects/README.md', 'chmod g-w', 'chmod g-w /home/ghost/projects/README.md', 'chmod u+x',
  'chmod u+x /home/ghost/projects/README.md',
  'chmod u+x run.sh', 'chown', 'chown root:root lockdown.conf', 'chown root:root ownership.txt',
  'chown www-data:www-data service.conf',
  'command -v', 'cp', 'cp /etc/hosts /home/ghost/hosts.backup', 'cp -i', 'cp -n', 'cp -p', 'crontab',
  'csplit', 'curl', 'curl -I', 'dd',
  ...
  'renice', 'rm', 'rm -i', 'rm -i /tmp/session.lock', 'rm -i drill/nested/decoy.tmp', 'rm decoy.txt',
  'rsync', 'scp', 'screen',
  ...
  'touch -t', 'touch -t 202401010830 signal.conf', 'trap', 'tree', 'truncate',
  'truncate -s 16 /home/ghost/truncate-demo.txt', 'type', 'type -a',
